...
--
-- Throws 'SDL.Exception.SDLException' if there are no working Vulkan drivers installed.throwIf_
...
vkGetVkGetInstanceProcAddr :: MonadIO m => m VkGetInstanceProcAddrFunc
